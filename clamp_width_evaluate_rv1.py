...
from util.ClampWidthDataset import ClampWidthDataset
...
def evaluate_model(model_path, data_path, save_dir, generate_overlays=False, overlay_dir=None):
    ...
    testDataset = ClampWidthDataset(path=data_path,
...
if __name__ == "__main__":
    model_path = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_3/clamp/width/run_clamp_3/clamp_width_SegNextV2_2024-12-23_accuracy_train_0.98275_loss_0.00871_epoch_203_lr_0.003_time_1185.79M_alpha_0.7_beta_0.3_gamma_2_best.pth" 
    data_path = "/home/saqib/Projects/sebang_welding/Sebang_Latest_Dec24/clamp/weld/boxes/test"
    save_dir = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_3/clamp/width/run_clamp_3"  # Update with your desired folder to save outputs
    overlay_dir = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_3/clamp/width/run_clamp_3/overlays_test_3"  # Directory to save overlays if enabled
