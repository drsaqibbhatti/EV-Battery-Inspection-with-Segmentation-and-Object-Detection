...
def train(load_pre_trained_model=False):
    ...
    trainDataset = ClampWidthDataset(path="/home/saqib/Projects/sebang_welding/Sebang_Latest_Dec24/clamp/weld/boxes/train",
                                      transform=transAugProcess,num_images=None)

    trainDatasetLoader = DataLoader(trainDataset, batch_size=batchSize, shuffle=True, drop_last=False)

    validDataset = ClampWidthDataset(path="/home/saqib/Projects/sebang_welding/Sebang_Latest_Dec24/clamp/weld/boxes/test",
    ...
    # pretrained_model_path = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_3/clamp/width/run_clamp_1/clamp_width_CustomSegmentationV4_2024-12-10_accuracy_train_0.96307_loss_0.01894_epoch_3_lr_0.003_time_30.34M_alpha_0.7_beta_0.3_gamma_2_best.pth"
    # # ###################################################################################################################################
    ...
    dataset_name = "clamp_width"
    build_date = str(date.today())
    model_name = f"{dataset_name}_{model_arch}_{build_date}_accuracy"
    date_dir = os.path.join(Base_dir, 'trainedModel/Phase_3/clamp/width')
