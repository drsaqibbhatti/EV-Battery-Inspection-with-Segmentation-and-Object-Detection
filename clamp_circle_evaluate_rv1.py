...
def evaluate_model(model_path, data_path, save_dir, generate_overlays=False, overlay_dir=None):
    ...
    testDataset = CircleDataset(path=data_path,
    ...
    sns.heatmap(conf_matrix_normalized * 100, annot=True, fmt=".2f", cmap="Blues", xticklabels=['Background', 'Circle'], yticklabels=['Background', 'Circle'])
...
if __name__ == "__main__":
    model_path = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_2025/clamp/circle/run_clamp_3/clamp_circle_SegNextV2_2025-04-02_accuracy_acc_0.92299_loss_0.04124_E_5_time_57.38min_W640_H640_best.pth" 
    data_path = "/home/saqib/Projects/sebang_welding/Sebang_Latest_Mar25/clamp/circle/dataset"
    save_dir = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_2025/clamp/circle/run_clamp_3"  # Update with your desired folder to save outputs
    overlay_dir = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_2025/clamp/circle/run_clamp_3/overlays_test"  # Directory to save overlays if enabled
