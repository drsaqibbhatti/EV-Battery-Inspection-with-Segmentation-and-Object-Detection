    ...
    with torch.no_grad():
        for i, (X_test, Y_test) in enumerate(tqdm(testDatasetLoader, desc="Evaluating", total=len(testDatasetLoader))):
            ...
            if generate_overlays and overlay_dir:
                ...
                cv2.putText(stacked_image, precision_text, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 255, 0), 1)
                cv2.putText(stacked_image, recall_text, (10, 85), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (95, 113, 70), 1)
                cv2.putText(stacked_image, f1_score_text, (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (94, 66, 109), 1)
...
if __name__ == "__main__":
    model_path = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_3/busbar_cu/pinhole/run_busbar_cu_7_imgsz_1440_360/cu_pinhole_SegNextV2_2025-01-22_accuracy_train_0.882805940_loss_0.062683329_epoch_496_lr_0.003_time_2309.57M_best.pth" 
    data_path = "/home/saqib/Projects/sebang_welding/Sebang_Latest_Dec24/SV_busbar_v2/Busbar_Cu/images_inspection/dataset"
    save_dir = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_3/busbar_cu/pinhole/run_busbar_cu_7_imgsz_1440_360"  # Update with your desired folder to save outputs
    overlay_dir = "/home/saqib/Projects/sebang_welding/trainedModel/Phase_3/busbar_cu/pinhole/run_busbar_cu_7_imgsz_1440_360/overlays_test"  # Directory to save overlays if enabled
